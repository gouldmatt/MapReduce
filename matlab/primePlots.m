...
load('351 Data Lab 3.mat') 



method1Norm = fitdist([wordMap14 wordMap28 wordMap56 wordMap112]','Normal')
method2Norm = fitdist([wordSingle14 wordSingle28 wordSingle56 wordSingle112]','Normal')
method3Norm = fitdist(primeMap','Normal')
method4Norm = fitdist(primeSingle','Normal')
...
hold off 
title('Figure 5 - Prime Number Frequency Results')
print('Figure 5 - Prime Number Frequency Results','-dpng')
